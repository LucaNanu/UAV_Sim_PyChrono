...
body_1.SetInertiaXX(chrono.ChVectorD(0.02167468,0.01555559,0.02225747))
body_1.SetInertiaXY(chrono.ChVectorD(1.08e-06,-5.82e-06,0.00026918))
body_1.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-4.00500000000224e-05,-0.05773638,-0.00642219),chrono.ChQuaternionD(1,0,0,0)))
...
marker_1_1.Impose_Abs_Coord(chrono.ChCoordsysD(chrono.ChVectorD(0,0,0),chrono.ChQuaternionD(1,0,0,0)))

# Auxiliary marker (coordinate system feature)
marker_1_2 =chrono.ChMarker()
marker_1_2.SetName('Solidworks_CoG_coord_system')
body_1.AddMarker(marker_1_2)
marker_1_2.Impose_Abs_Coord(chrono.ChCoordsysD(chrono.ChVectorD(-4.00500000000224E-05,-0.05773638,-0.00642219),chrono.ChQuaternionD(1,0,0,0)))
