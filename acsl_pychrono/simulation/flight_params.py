...
class FlightParams:
    ...
    def _init_ts_uav(self):
        ...
        # ---- DO NOT USE, use marker_motors instead ----
        # position wrt local frame (REFERENCE POINT and NOT CoM) of where to apply the thrust force generated by motors 1
    ...
    def _init_x8copter(self):
        ...
        # ---- DO NOT USE, use marker_motors instead ----
        # position wrt local frame (from REFERENCE POINT and NOT CoM) of where to apply the thrust force generated by motors 1 & 5
